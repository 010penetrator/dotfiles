 ...
 * |  \   |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  |  [   |  ]   |Lower |Space |  '   |Raise | Left | Rght | Alt  |Shift |
 * `-----------------------------------------------------------------------------------'
[_QWERTY] = LAYOUT_planck_grid(
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
    KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_BSLS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
    KC_LCTL, KC_LGUI, KC_LBRC, KC_RBRC, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_PGDN, KC_PGUP, KC_LALT, KC_LSFT
),
 */

[_QWERTY] = LAYOUT_planck_grid(
    SFT_T(KC_TAB)  , KC_Q   , KC_W    , KC_E  , KC_R  , KC_T   , KC_Y   , KC_U   , KC_I    , KC_O    , KC_P    , KC_BSPC ,
    KC_ESC  , KC_A   , KC_S    , KC_D  , KC_F  , KC_G   , KC_H   , KC_J   , KC_K    , KC_L    , KC_SCLN , KC_UP   ,
    KC_DEL  , KC_Z   , KC_X    , KC_C  , KC_V  , KC_B   , KC_N   , KC_M   , KC_COMM , KC_DOT  , KC_SLSH , KC_DOWN ,
    KC_LCTL , KC_LGUI , ALT_T(KC_LBRC) , NU_T(KC_RBRC), LOWER , KC_SPC , NU_T(KC_QUOT) , RAISE , KC_LEFT , KC_RGHT , ALT_T(KC_BSLS) , SFT_T(KC_ENT)
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______ , _______ , KC_LABK , KC_RABK , _______ , KC_0    , _______ , KC_LBRC , KC_RBRC , KC_LCBR , KC_RCBR , _______ ,
    _______ , _______ , _______ , _______ , _______ , KC_DOT  , _______ , _______ , _______ , _______ , _______ , _______
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______ , KC_F9   , KC_F10  , KC_F11  , KC_F12  , _______ , KC_PGDN , KC_MINS , KC_UNDS , KC_PLUS , KC_EQL  , KC_PGDN ,
...
[_NUMER] = LAYOUT_planck_grid(
    _______ , _______ , KC_PGUP , KC_END  , _______ , _______ , KC_NLCK , KC_P7 , KC_P8   , KC_P9  , KC_PMNS , _______ ,
    _______ , KC_HOME , KC_INS  , KC_DEL  , KC_PGDN , _______ , KC_CIRC , KC_P4 , KC_P5   , KC_P6  , KC_PPLS , _______ ,
    _______ , KC_UNDS , KC_MINS , KC_PLUS , _______ , _______ , KC_PAST , KC_P1 , KC_P2   , KC_P3  , KC_PSLS , _______ ,
    _______ , _______ , _______ , _______ , _______ , _______ , _______ , KC_P0 , KC_P0   , KC_PDOT , KC_EQL , _______
),
