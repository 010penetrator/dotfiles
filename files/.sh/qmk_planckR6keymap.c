...
// Keymap by plasmik for planck keyboard rev.6
 ...
 * |  \   |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  | Down |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  | Alt  |Numer |Lower |Space |  '   |Raise |   [  |   ]  | Del  |Shift |
 * `-----------------------------------------------------------------------------------'
*/
...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_BSLS       , KC_Z    , KC_X    , KC_C  , KC_V  , KC_B   , KC_N          , KC_M  , KC_COMM , KC_DOT  , KC_SLSH , KC_DOWN       ,
    KC_LCTL       , KC_LGUI , KC_LALT , NUMER , LOWER , KC_SPC , NU_T(KC_QUOT) , RAISE , KC_LBRC , KC_RBRC , KC_DEL  , SFT_T(KC_ENT)
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______ , _______ , KC_LABK , KC_RABK , KC_LSFT , KC_0    , _______ , KC_DOT  , _______ , KC_LCBR , KC_RCBR , KC_PGDN ,
...
[_NUMER] = LAYOUT_planck_grid(
    ...
    _______ , _______ , _______ , _______ , _______ , _______ , _______ , KC_P0 , KC_PDOT , KC_PDOT , KC_EQL , _______
),
