...
KEYMAP(
    ...
    KC_LCTL       , KC_Z     , KC_X   , KC_C    , KC_V    , KC_B      , KC_N    , KC_M    , KC_COMM , KC_DOT , KC_SLSH , MO(1)    ,
          CTL_T(KC_QUOT) ,  KC_SPC ,  KC_LGUI  , KC_DEL , KC_ENT  ,   KC_LSFT ,     KC_LBRC  ,  CTL_T(KC_RBRC)  ),
...
KEYMAP(
    ...
    KC_LALT       ,  KC_HOME  ,  KC_S    ,  KC_MINS ,  KC_PGDN ,  KC_GRV    ,  KC_H    ,  KC_UNDS     ,  KC_K    ,  KC_EQL  ,  KC_QUOT,  KC_PGDN  ,
    KC_LCTL      ,  KC_UNDS  ,  KC_MINS  ,  KC_PLUS ,  KC_EQL  ,  KC_BSLS   ,  KC_BSLS ,   KC_MINS    ,  KC_UNDS ,  KC_PLUS ,   KC_EQL , MO(1)   ,
                KC_LCTL ,  KC_SPC  ,   KC_LGUI,    KC_BSLS  ,  KC_CAPSLOCK  ,    KC_RSFT     ,   KC_LEFT      ,  KC_RIGHT )
};
