...
KEYMAP(
    ...
    KC_LALT       ,  KC_HOME  ,  KC_S   ,  KC_D    ,  KC_F    ,  KC_GRV        ,  KC_H    ,  KC_J         ,  KC_K    ,  KC_L    ,  KC_QUOT,  KC_PGDOWN ,
    KC_LCTL      ,  KC_UNDS  ,  KC_MINS,  KC_PLUS ,  KC_EQL  ,  KC_BSLS       ,  KC_GRV  ,   KC_MINS      ,  KC_UNDS ,  KC_PLUS ,   KC_EQL , MO(1)    ,
                KC_LCTL ,  KC_SPC  ,   KC_LGUI,     KC_DEL  ,  KC_ENT  ,    KC_RSFT     ,   KC_LEFT      ,  KC_RIGHT )
};
